...
static void* CCImage_initWithString = (void*)0x10013f48a;
static void *(*cpp_new)(unsigned long size) = (void*)0x10019f2f4; // operator new[](unsigned long)
static void (*cpp_delete)(void *ptr) = (void*)0x10019f2e8; // operator delete[](void*)
